export default function Poem() {
	return (
		<div className="absolute left-[-12px] top-[-20px] overflow-hidden text-white w-[620px] text-lg h-[500px]">
			...
			unfinished ideas drift quietly between tabs,
			half-written thoughts waiting to become something real.

			A list of things to learn.
			A project never fully started.
			A sentence saved at 2:14 AM because it felt important.
			...
			The desk is cluttered with possibilities.

			Kubernetes.
			Distributed systems.
			Realtime sync.
			Rust experiments.
			A strange idea for an AI agent.

			Tiny fragments of curiosity scattered everywhere,
			like notes pinned across a wall.

			Not every thought needs structure.
			Some ideas just need a place to exist.

			<br />
			<br />

			There’s comfort in unfinished work.

			A paragraph without an ending.
